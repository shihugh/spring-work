...
<div class="g-doc">
    <div class="m-tab m-tab-fw m-tab-simple f-cb">
        <div class="tab">
            <ul>
                <li <#if !listType || listType != 1>class="z-sel"</#if> ><a href="/spring-work/">所有内容</a></li>
                <#if user && user.usertype == 0><li <#if listType == 1>class="z-sel"</#if> ><a href="/spring-work/?type=1">未购买的内容</a></li></#if>
            </ul>
        </div>
    </div>
    ...
    <div class="n-plist">
        ...
        <#if user && user.usertype == 0 && listType == 1>
            <#list productList as x>
                <#if !x.isBuy>
                <li id="p-${x.id}">
                    <a href="/spring-work/show?id=${x.id}" class="link">
...
<script type="text/javascript" src="/spring-work/js/global.js"></script>
<script type="text/javascript" src="/spring-work/js/pageIndex.js"></script>
</body>
</html>